...
namespace ShopCart.Tests
{
    public abstract class ShopCartTestBase : AbpIntegratedTestBase<ShopCartTestModule>
    {
        ...
        protected void UsingDbContext(Action<ShopCartDbContext> action)
        {
            UsingDbContext(AbpSession.TenantId, action);
        }

        protected Task UsingDbContextAsync(Func<ShopCartDbContext, Task> action)
        {
            return UsingDbContextAsync(AbpSession.TenantId, action);
        }

        protected T UsingDbContext<T>(Func<ShopCartDbContext, T> func)
        {
            return UsingDbContext(AbpSession.TenantId, func);
        }

        protected Task<T> UsingDbContextAsync<T>(Func<ShopCartDbContext, Task<T>> func)
        {
            return UsingDbContextAsync(AbpSession.TenantId, func);
        }

        protected void UsingDbContext(int? tenantId, Action<ShopCartDbContext> action)
        {
        ...
        protected async Task UsingDbContextAsync(int? tenantId, Func<ShopCartDbContext, Task> action)
        {
            using (UsingTenantId(tenantId))
            {
                using (var context = LocalIocManager.Resolve<ShopCartDbContext>())
        ...
        protected T UsingDbContext<T>(int? tenantId, Func<ShopCartDbContext, T> func)
        {
            T result;
